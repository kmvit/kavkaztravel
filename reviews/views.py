...
class ReviewViewSet(viewsets.ModelViewSet):
    ...
    def get_all_ratings_for_object(self, request, *args, **kwargs):
        ...
        reviews = Review.objects.filter(content_type=content_type_instance, object_id=object_id)
